 ...
 */
class Usermailboxconfig // extends CommonObject
{
    ...
    function create($user, $notrigger=0)
    {
		...
		if (isset($this->mailbox_imap_login)) $this->mailbox_imap_login=trim($this->mailbox_imap_login);
		if (isset($this->mailbox_imap_password)) $this->mailbox_imap_password=trim($this->mailbox_imap_password);
		if (isset($this->mailbox_imap_host)) $this->mailbox_imap_host=trim($this->mailbox_imap_host);
		if (isset($this->mailbox_imap_port)) $this->mailbox_imap_port=trim($this->mailbox_imap_port);
