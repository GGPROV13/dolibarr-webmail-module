...
function getmsg($mbox, $mid)
{
    ...
    if (!$s->parts)  // simple
            list($charset, $htmlmsg, $plainmsg, $attachments) = getpart($mbox,
                                                                        $mid,
                                                                        $s, 0,
                                                                        $charset,
                                                                        $htmlmsg,
                                                                        $plainmsg,
                                                                        $attachments);  // pass 0 as part-number
    else
...
function getpart($mbox, $mid, $p, $partno, $charset, $htmlmsg, $plainmsg,
                 $attachments)
{
