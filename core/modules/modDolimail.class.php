...
class modDolimail extends DolibarrModules
{
  ...
  function modDolimail($db)
  {
    ...
    $this->description = "Configuration Webmail";
    ...
    //                        );
    $this->module_parts = array();
    $this->module_parts = array('css' => array('/dolimail/css/dolimail.css.php'));
    // Data directories to create when module is enabled.
    // Example: this->dirs = array("/mymodule/temp");
    $this->dirs = array();

    // Config pages. Put here list of php page, stored into mymodule/admin directory, to use to setup module.
    $this->config_page_url = array("index.php@dolimail");
  ...
  {
    return $this->_load_tables('/dolimail/sql/');
  }
